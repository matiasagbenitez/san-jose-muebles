...
export class SupplierOwnAccountsListEntity {
    constructor(
        public id: string,
        public currency: {
            name: string,
    ...
    static fromObject(object: { [key: string]: any }): SupplierOwnAccountsListEntity {
        ...
        return new SupplierOwnAccountsListEntity(
            id,
            {
                name: currency.name,
