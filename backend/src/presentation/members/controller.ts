...
export class MemberController {
    ...
    protected service: MemberService = new MemberService();
    ...
    getAllPaginated = async (req: Request, res: Response) => {
        ...
        this.service.getMembersPaginated(paginationDto!, filters as MemberFilters)
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
    ...
    getById = async (req: Request, res: Response) => {
        ...
        this.service.getMember(parseInt(id))
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
    ...
    create = async (req: Request, res: Response) => {
        ...
        this.service.createMember(createDto!)
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
    ...
    update = async (req: Request, res: Response) => {
        ...
        this.service.updateMember(id, updateDto!)
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
    ...
    delete = async (req: Request, res: Response) => {
        ...
        this.service.deleteMember(parseInt(id))
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
