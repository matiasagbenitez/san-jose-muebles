...
import { BankService, BankFilters } from '../services/bank.service';
...
export class BankController {
    ...
    getAllPaginated = async (req: Request, res: Response) => {
        ...
        this.bankService.getBanksPaginated(paginationDto!, filters as BankFilters)
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
    ...
    create = async (req: Request, res: Response) => {
        ...
        this.bankService.createBank(createDto!)
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
    ...
    update = async (req: Request, res: Response) => {
        ...
        this.bankService.updateBank(id, updateDto!)
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
    ...
    delete = async (req: Request, res: Response) => {
        ...
        this.bankService.deleteBank(parseInt(id))
            .then((data) => {
                res.json(data);
            })
            .catch((error) => {
